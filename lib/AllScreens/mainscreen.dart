...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
 ...
 /* void getCurrentDriverInfo() async {
                                    ...
                                    Container(
                                      ...
                                      child: FittedBox(
                                        ...
                                        child: Container(
                                          child: Text(
                                            ((tripDirectionDetails != null)
                                                ? "${(AssistantMethods.calculateFares(tripDirectionDetails!)) * 30} PKR"
                                                : " "),
                                            style: TextStyle(
                                                fontSize: 16.0,
                                                color: Colors.grey),
                                    ...
                                    Container(
                                      ...
                                      child: FittedBox(
                                        ...
                                        child: Container(
                                          child: Text(
                                            ((tripDirectionDetails != null)
                                                ? "${(AssistantMethods.calculateFares(tripDirectionDetails!)) * 50} PKR"
                                                    : " "),
                                            style: TextStyle(
                                                fontSize: 16.0,
                                                color: Colors.grey),
                                    ...
                                    Container(
                                      ...
                                      child: FittedBox(
                                        ...
                                        child: Container(
                                          child: Text(
                                            ((tripDirectionDetails != null)
                                                ? "${(AssistantMethods.calculateFares(tripDirectionDetails!)) * 70} PKR"
                                                : " "),
                                            style: TextStyle(
                                                fontSize: 16.0,
                                                color: Colors.grey),
  ...
  void notifyDriver(NearbyAvailableDrivers drivers) {
    ...
    driversRef.child(drivers.key).child("token").once().then((DataSnapshot dataSnapshot) {
